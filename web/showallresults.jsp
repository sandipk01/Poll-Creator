...
String QueryString = "SELECT * from poll";
...
<center>
       ...
       <div class="container">
           <div class="alert alert-success" style=" font-style: italic; opacity: 0.6; filter: alpha(opacity=100);">
               <strong>&nbsp;&nbsp;&nbsp;<label>Poll Genrated By,&nbsp;&nbsp;&nbsp;<label style="color:#7D1935;"><%=rs.getString(2)%></label></label>&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/click.gif" height="60" width="60">&nbsp;&nbsp;<a style="color:green; font-size: 20px;" href="showresult1.jsp?pollidcurrent=<%=rs.getString(1)%>"><%=rs.getString(3)%></a>&nbsp;&nbsp;&nbsp;Last Date Is:&nbsp;&nbsp;&nbsp;<label style="color:#7D1935;"><%=rs.getString(9)%></label></strong> 
...
%>
<a href="showresult.jsp" class="btn btn-info" role="button">back to page</a>
<%
